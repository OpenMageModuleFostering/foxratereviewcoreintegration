...
class Foxrate_ReviewCoreIntegration_Model_Reviewtotals extends Mage_Core_Model_Abstract
{
    ...
    public function getRatingSummary()
    {
        ...
        return Mage::helper('reviewcoreintegration')->formatCalcPercent($productPage['average'], 5);
    }
