...
class Foxrate_Sdk_Api_Components_Secure
{
    /**
     * Foxrate secret key
     */
    ...
    public function __construct($username, $password, Foxrate_Sdk_Api_TranslatorInterface $translator)
    {
     ...
     *
     * @param $hash
     * @throws Foxrate_Sdk_Api_Exception_Communicate
     */
    public function isSecureCall($hash)
    {
        if (!$this->checkToken($hash, $this->username, $this->password)) {
            throw new Foxrate_Sdk_Api_Exception_Communicate($this->translator->trans('ERROR_Foxrate_Sdk_CHECK'));
        }
    }
