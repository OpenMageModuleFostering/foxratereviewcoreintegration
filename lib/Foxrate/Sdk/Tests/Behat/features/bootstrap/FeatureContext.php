...
class FeatureContext extends MinkContext
{
    ...
    static $selServer='http://192.168.128.1:4444/wd/hub';   //selenium server ip
    ...
    {
        if(!isset(self::$mink)){
            $driver = new Behat\Mink\Driver\Selenium2Driver(self::$selBrowser, null, self::$selServer);
    ...
    public function iShouldSeeFoxrateProductReviews()
    {
        ...
        $reviews_tab = $this->session->getPage()->find('css', 'a[href^="#idTab5Foxrate"]');
    ...
    public function productHasOneReviewWithRating($rating)
    {
        ...
        $path  = 'cache/FoxrateCache/ProductReviews/1.gener.json';
