...
class Foxrate
{
     ...
     * Foxrate API url
     */
    protected $_foxrateAPIUrl = 'http://foxrate.vm/';

    /**
     * Foxrate symfony2 api
     * @var string
     */
    protected $_FoxrateAPI2Url  = 'http://api.foxrate.vm';
     ...
     */
    protected $_foxratePluginVersion = '3.3';
    ...
    {
        $url = $this->_foxrateAPIUrl . 'feedback_api/is_user_exist.php';
    ...
    public function setShopModuleUrl($user, $pass)
    {
        ...
        $shopModuleUrl = $this->_foxrateAPIUrl . 'feedback_api/set_shopmodule_url.php';
        ...
        $params['shop_module_url'] = Mage::getUrl('reviewcoreintegration', array('_store' => $this->getStoreId() ));
