	...
	var defaults = {
		...
		*/
		...
		setStylesOfFadingLayer : {// define the opacity and color of fader layer here
			white : 'background-color:#fff; filter:alpha(opacity=0); -moz-opacity:0; opacity:0;',
			black : 'background-color:#000; filter:alpha(opacity=0); -moz-opacity:0; opacity:0;',
	...
	jQuery.fn.modalBox = function( method ) {
		...
		jQuery(".openmodalbox").modalBox({
                ...
                setStylesOfFaderLayer:{// define the opacity and color of fader layer here
                    white:'background-color:#fff; filter:alpha(opacity=0); -moz-opacity:0; opacity:0;',
                    black:'background-color:#000; filter:alpha(opacity=0); -moz-opacity:0; opacity:0;',
                    getStaticContentFrom : ".modalboxContent",
                    transparent:'background-color:transparent;'
                },
